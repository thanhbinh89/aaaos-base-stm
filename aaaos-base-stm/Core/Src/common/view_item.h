...
#define NUMBER_SCREEN_ITEMS_MAX		(6)
...
#define UPDATE_SCREEN_ITEM			(0x02)
#define NONE_UPDATE_SCREEN			(0x03)

#define ITEM_TYPE_RECTANGLE			(0x00)
#define ITEM_TYPE_DYNAMIC			(0x01)
#define NUMBERS_ITEM_TYPE			(0x02)

#define ITEM_TYPE_ALINE_LEFT		(0x00)
#define ITEM_TYPE_ALINE_CENTER		(0x01)
#define ITEM_TYPE_ALINE_RIGHT		(0x02)

/* define rectangle item */
#define RECTANGLE_TEXT_LENGH_MAX	(24)
...
typedef struct {
	...
	uint8_t focus_item;
	uint8_t focus_item_before;
	uint8_t focus_item_after;
} view_screen_t;
